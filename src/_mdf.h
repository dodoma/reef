...
typedef enum {
    ...
    A_PAIR,
    A_PAIR_R_RAW, A_PAIR_R_QUOTE, A_PAIR_R_NUMBER, A_PAIR_R_DOUBLE,
    ...
    A_ARRAY,
    A_VALUE_RAW, A_VALUE_QUOTE, A_VALUE_NUMBER, A_VALUE_DOUBLE,
    ...
    A_DATA_QUOTE, A_DATA_NUMBER, A_DATA_DOUBLE, A_DATA_RESERVE, A_UNDATA_QUOTE,
